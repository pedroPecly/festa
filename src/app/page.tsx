...
export default async function Home({ searchParams }: PageProps) {
  ...
  return (
    <div id="inicio" className="min-h-screen bg-[#f6f2ec] text-[#1b1a17]">
      <div className="relative">
        ...
        <main className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 pb-20 pt-6 md:px-10 md:pb-28 md:pt-12">
          <HeroSection
